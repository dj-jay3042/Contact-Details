        ...
        init: function () {
            (function ($) {
                $(document).idleTimeout({
                    redirectUrl: "/logout.php", // redirect to this url. Set this value to YOUR site's logout page.
                    ...
                    sessionKeepAliveUrl: '/keepalive.php' // set URL to ping - does not apply if sessionKeepAliveTimer: false
                });
            })(jQuery);
